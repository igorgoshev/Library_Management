...
export class UserLayoutComponent {
  ...
  @ViewChild(UserSideBarComponent) appSidebar!: UserSideBarComponent;

  @ViewChild(UserTopBarComponent) appTopbar!: UserTopBarComponent;
...
import { UserFooterComponent } from './admin-footer/admin-footer.component';
import { NavigationEnd, Router, RouterOutlet } from '@angular/router';
import { NgClass } from '@angular/common';
import { filter, Subscription } from 'rxjs';
import { LayoutService } from './layout.service';
...
@Component({
  selector: 'app-admin-layout',
  standalone: true,
  imports: [AdminTopBarComponent, AdminSideBarComponent, UserFooterComponent, RouterOutlet, NgClass],
